...
namespace Service.Helper
{
    public class ProgressBar : IDisposable, IProgress<double>
    {
        ...
        private readonly (int Left, int Top) printLine;
        ...
        public ProgressBar(string fileName)
        {
            ...
            printLine = Console.GetCursorPosition();
        ...
        private void UpdateText(string text)
        {
			...
			*/
            ...
            // Backtrack to the first differing character
            StringBuilder outputBuilder = new StringBuilder(text[0..^1]);

            // Output new suffix
            outputBuilder.Append(text.Substring(text.Length - 1));
			...
			*/
            ...
            Console.SetCursorPosition(printLine.Left, printLine.Top);
